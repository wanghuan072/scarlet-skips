...
const placeholder = `The listed address, ${siteConfig.email}, uses the reserved .test domain. It is a development placeholder, and delivery is not verified. A working contact address must replace it before public launch.`;
...
export const legalPages: Record<string, PageData> = {
  about: {
    ...
    sections: [
      ...
      { heading: "Independence and corrections", paragraphs: ["Scarlet Skips Hub is not developed, sponsored or endorsed by Yerk Games, YerkDiff, Valve or Steam. If you spot an error, see Contact Us.", placeholder] },
    ],
  },
  contact: {
    ...
    sections: [
      ...
      { heading: "Email during development", paragraphs: [placeholder, "Do not send passwords, account details or executable files."] },
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: "Requests and hosting", paragraphs: ["A hosting service may process request details such as IP address, browser information, requested URL and time for delivery and security. This development site uses a Vercel preview domain. We do not claim that no hosting logs exist; the provider's own privacy notice also applies.", "No site-operated analytics or advertising tracker is represented as active in this build. Review this statement if hosting, analytics or embedded services change."] },
      ...
      { heading: "Questions and changes", paragraphs: [placeholder, "Review this policy before public launch and whenever the site's data handling changes."] },
    ],
  },
  terms: {
    ...
    sections: [
      ...
      { heading: "Changes and contact", paragraphs: ["These terms may change as the guide or its hosting changes.", placeholder] },
    ],
  },
  copyright: {
    ...
    sections: [
      ...
      { heading: "Corrections and rights-holder requests", paragraphs: ["For a credit correction or concern about specific material, identify the page URL and the item involved.", placeholder] },
    ],
  },
};
