...
export function Icon({
  ...
  const paths: Record<IconName, ReactNode> = {
    ...
    fall: <><path d="M12 3v12" {...common}/><path d="m8 11 4 4 4-4" {...common}/><path d="M5 19h14" {...common}/></>,
    ...
    person: <><circle cx="12" cy="7" r="3.5" {...common}/><path d="M5.5 20c1.2-3.6 3.5-5.5 6.5-5.5s5.3 1.9 6.5 5.5" {...common}/></>,
